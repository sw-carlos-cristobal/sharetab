...
async function goToAdminAndWaitForProviderSection(
  page: Page,
...
test.describe('AI Provider Test UI', () => {
  test('section renders with upload button and disabled provider buttons', async ({ page }, testInfo) => {
  ...
  test('uploading a receipt image shows filename and enables provider buttons', async ({ page }, testInfo) => {
    await goToAdminAndWaitForProviderSection(page, testInfo);
  ...
  test('uploading an invalid file type does not enable provider buttons', async ({ page }, testInfo) => {
    await goToAdminAndWaitForProviderSection(page, testInfo);
