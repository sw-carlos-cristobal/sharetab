  ...
  projects: [
    // Tests that mutate or depend on shared seed data — run serially first
    {
      ...
      testMatch: [
        ...
        'expenses.spec.ts',
        'groups.spec.ts',
        'mobile-admin.spec.ts',
        'sidebar.spec.ts',
        'receipt-ui.spec.ts',
        'split-item-ui.spec.ts',
        'venmo-toggle.spec.ts',
        'guest-upload-toggle.spec.ts',
        'venmo-profile.spec.ts',
        'venmo-deeplink.spec.ts',
        'venmo-settle.spec.ts',
      ],
      fullyParallel: false,
      workers: 1,
