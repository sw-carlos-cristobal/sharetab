...
import { parseExtractedData, parseGuestItems, parseGuestPeople, parseGuestAssignments } from './json-schemas';
...
describe('parseGuestPeople', () => {
  it('parses valid people array', () => {
    const people = parseGuestPeople([{ name: 'Alice' }, { name: 'Bob', personToken: 'abc-123', groupSize: 2 }]);
